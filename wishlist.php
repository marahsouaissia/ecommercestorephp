...
// Fetch wishlist data
$sql = "SELECT wishlist.id, product.id AS product_id, product.name, product.price, product.image 
        FROM wishlist 
                              ...
                              <?php foreach ($wishlist_items as $item): ?>
                                  <tr>
                                      ...
                                      <td class="product-remove">
                                          <a href="assets/php/remove_from_wishlist.php?id=<?php echo $item['id']; ?>">
